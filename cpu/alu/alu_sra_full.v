module alu_sra_full (data_result, data_operandA, ctrl_shiftamt);
    ...
    alu_sra_1 sra_1(w1, data_operandA, ctrl_shiftamt);
    alu_mux_2 mux_1(w2, ctrl_shiftamt[0], data_operandA, w1);

    alu_sra_2 sra_2(w3, w2, ctrl_shiftamt);
    alu_mux_2 mux_2(w4, ctrl_shiftamt[1], w2, w3);
    
    alu_sra_4 sra_4(w5, w4, ctrl_shiftamt);
    alu_mux_2 mux_3(w6, ctrl_shiftamt[2], w4, w5);

    alu_sra_8 sra_8(w7, w6, ctrl_shiftamt);
    alu_mux_2 mux_4(w8, ctrl_shiftamt[3], w6, w7);

    alu_sra_16 sra_16(w9, w8, ctrl_shiftamt);
